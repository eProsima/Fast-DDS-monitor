...
Item {
    id: statusView
    // Managed by a StackLayout in StatusPanel -> use Layout.* instead of anchors
    ...
    TreeView {
        ...
        function applyValueColumnWidth() {
            treeView.setColumnWidth(1, statusView.width - treeView.columnWidth(0))
        }
        ...
        delegate: Item {
            implicitWidth: column === 0 ? 2 * statusView.width / 3 : statusView.width - treeView.columnWidth(0)
