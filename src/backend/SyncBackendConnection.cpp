...
#include <fastdds-low-bandwidth-transports/PayloadCompressionTransportDescriptor.h>
#include <fastdds-low-bandwidth-transports/HeaderReductionTransportDescriptor.h>
#include <fastdds-low-bandwidth-transports/SourceTimestampTransportDescriptor.h>
        ...
        int domain)
{
    ...
    try
    {
        return StatisticsBackend::init_monitor(domain, participant_qos);
    }
    catch (const Error& e)
    {
