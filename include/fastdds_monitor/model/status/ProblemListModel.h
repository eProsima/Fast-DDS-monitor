...
/**
 * @file ProblemListModel.hpp
 */

#ifndef _EPROSIMA_FASTDDS_MONITOR_MODEL_STATUS_LISTMODEL_H
#define _EPROSIMA_FASTDDS_MONITOR_MODEL_STATUS_LISTMODEL_H
 ...
 *
 * The \c ProblemListModel contains a serie of \c ProblemListItem , which each of them represents a backend \c Entity .
...
public:
     ...
     */
    QList<ProblemListItem*> to_QList() const;
...
protected:
    ...
    //! Void ProblemListItem that is used to know the role names. This is why a default constructor is needed in \c ProblemListItem
    ProblemListItem* prototype_;
...
#endif // _EPROSIMA_FASTDDS_MONITOR_MODEL_STATUS_LISTMODEL_H
