...
/**
 * @file ProblemListItem.hpp
 */

#ifndef _EPROSIMA_FASTDDS_MONITOR_MODEL_STATUS_LISTITEM_H
#define _EPROSIMA_FASTDDS_MONITOR_MODEL_STATUS_LISTITEM_H
 ...
 */
class ProblemListItem : public QObject
{
    Q_OBJECT
...
public:
     ...
     *
     * In Abstract ProblemListItem it allows to get the id and name of the entity.
...
protected:
    ...
    backend::ConnectionListSample connection_list_sample_;
    backend::DeadlineMissedSample deadline_missed_sample_;
    backend::IncompatibleQosSample incompatible_qos_sample_;
    backend::InconsistentTopicSample inconsistent_topic_sample_;
    backend::LivelinessChangedSample liveliness_changed_sample_;
    backend::LivelinessLostSample liveliness_lost_sample_;
    backend::ProxySample proxy_sample_;
    backend::SampleLostSample sample_lost_sample_;
    backend::StatusesSizeSample statuses_size_sample_;
...
#endif // _EPROSIMA_FASTDDS_MONITOR_MODEL_STATUS_LISTITEM_H
