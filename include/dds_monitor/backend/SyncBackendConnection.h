...
#ifndef _EPROSIMA_DDS_MONITOR_BACKEND_SYNCBACKENDCONNECTION_H
#define _EPROSIMA_DDS_MONITOR_BACKEND_SYNCBACKENDCONNECTION_H
...
#endif // _EPROSIMA_DDS_MONITOR_BACKEND_SYNCBACKENDCONNECTION_H
