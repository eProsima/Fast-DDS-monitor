...
#ifndef _EPROSIMA_DDS_MONITOR_BACKEND_STATUS_CALLBACK_H
#define _EPROSIMA_DDS_MONITOR_BACKEND_STATUS_CALLBACK_H
...
#endif // _EPROSIMA_DDS_MONITOR_BACKEND_STATUS_CALLBACK_H
