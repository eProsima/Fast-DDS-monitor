...
#ifndef _EPROSIMA_DDS_MONITOR_STATISTICS_DATACHARTBOX_H
#define _EPROSIMA_DDS_MONITOR_STATISTICS_DATACHARTBOX_H
...
#endif // _EPROSIMA_DDS_MONITOR_STATISTICS_DATACHARTBOX_H
