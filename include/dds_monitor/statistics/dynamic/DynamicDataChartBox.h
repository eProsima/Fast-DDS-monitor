...
#ifndef _EPROSIMA_DDS_MONITOR_STATISTICS_DYNAMIC_DYNAMICCHARTBOX_H
#define _EPROSIMA_DDS_MONITOR_STATISTICS_DYNAMIC_DYNAMICCHARTBOX_H
...
#endif // _EPROSIMA_DDS_MONITOR_STATISTICS_DYNAMIC_DYNAMICCHARTBOX_H
