...
#ifndef _EPROSIMA_DDS_MONITOR_ENGINE_H
#define _EPROSIMA_DDS_MONITOR_ENGINE_H
...
#include <dds_monitor/backend/AlertCallback.h>
#include <dds_monitor/backend/StatusCallback.h>
...
protected:
    ...
    //! Data Model for DDS Monitor status. Collects the total amount of entities discovered by the monitor
    models::TreeModel* status_model_;

    //! User data Model for DDS Monitor topic spy view
    ...
    //! Data Model for DDS Monitor status view. Collects all entities statuses detected by the monitor service
    models::StatusTreeModel* entity_status_model_;

    //! Display and allow to filter Model for DDS Monitor status view.
...
#endif // _EPROSIMA_DDS_MONITOR_ENGINE_H
