...
DDS Monitor is a useful tool for monitoring and studying a ROS 2 network.
...
as well as a brief tutorial demonstrating the integration of DDS Monitor with ROS 2 in a simple scenario.
