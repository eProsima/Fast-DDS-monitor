...
Pressing right-click on the IDL view, a contex menu appears with the options to copy the selected text from the
...
as is recieved by the monitor. View->Perform ROS 2 Demangling allows to perform the demangling operation again.
