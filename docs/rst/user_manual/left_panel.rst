...
In these left panels are displayed the different entities that the application has information from.
...
- Click in the Participant name or the Participant icon will expand or collapse the list of Endpoints of the
  Participant.
- Click in the Endpoint name or the Endpoint icon will expand or collapse the list of Locators of the Endpoint.
- Double click in an Entity will set this entity as *selected*. For more information refer to :ref:`selected_entity`
...
- Click in the Host name or the Host icon will expand or collapse the list of Users of the Host.
- Click in the User name or the User icon will expand or collapse the list of Processes of the User.
- Double click in an Entity will set this entity as *selected*. For more information refer to :ref:`selected_entity`
...
- Click in the Domain name or the Domain icon will expand or collapse the list of Topics of the Domain.
- Double click in an Entity will set this entity as *selected*. For more information refer to :ref:`selected_entity`.
