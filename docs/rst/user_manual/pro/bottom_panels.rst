...
Explorer Panel and in the Domain View.
...
The Entity Summary Bar sits in the bottom status bar of the window, to the right of the error and
warning counters, separated from them by a vertical divider.
It remains visible regardless of which monitor tab is active or how the workspace layout is arranged.
